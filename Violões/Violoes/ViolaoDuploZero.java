public class ViolaoDuploZero implements GuitarraPrototype {
    private String nome;
    ...
    public ViolaoDuploZero() {
        this.nome = "Violão Duplo Zero (00)";
        this.tipoCorda = "Nylon";
        this.descricao = "Parlor - tamanho médio-pequeno, ideal para fingerstyle";
        this.preco = 550.00;
    }
