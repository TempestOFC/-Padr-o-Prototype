public class Violao7Cordas implements GuitarraPrototype {
    private String nome;
    ...
    public Violao7Cordas() {
        this.nome = "Violão 7 Cordas";
        this.tipoCorda = "Nylon";
        this.descricao = "Violão brasileiro com sétima corda mais grave, para choro e samba";
        this.preco = 1100.00;
    }
